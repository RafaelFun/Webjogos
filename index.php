...
<html lang = "pt-br">
  ...
  <body>
    ...
    <div id = "games"> 
      ...
      ?>
      <table border="2">
        <tr><th>Jogo</th><th>Gênero</th><th>Empresa</th><th>Data de lançamento</th><th>Multiplayer</th><th>Preço</th></tr>
        <?php
          while($linha = mysqli_fetch_assoc($dados)) {
            ...
            $preco = $linha["preco"];
            echo " <tr><td>$nome</td><td>$genero</td><td>$empresa</td><td>$ano</td><td>$multi</td><td>R$ $preco</td></tr>\n";
          }
